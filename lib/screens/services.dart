...
class _ServicesState extends State<Services> {
  ...
  final List<Service> serviceList = [
    ...
    Service(
        ...
        description: "Hello Free world",
        url:
            "https://images.pexels.com/photos/270408/pexels-photo-270408.jpeg?cs=srgb&dl=pexels-pixabay-270408.jpg&fm=jpg"),
    Service(
        name: "Photography",
        description: "Hello Free world",
        url:
    ...
    Service(
        name: "Marketing",
        description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Tincidunt tortor aliquam nulla facilisi cras fermentum odio eu. "
            ...
            " pulvinar sapien et ligula. Accumsan sit amet nulla facilisi morbi tempus iaculis urna id.",
        url:
            "https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?cs=srgb&dl=pexels-lukas-590016.jpg&fm=jpg"),
  ];
                        ...
                        children: [
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(currentService.url,
